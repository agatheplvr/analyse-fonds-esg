...
st.set_page_config(page_title="Analyse ESG & Portefeuille", layout="wide")
...
# === Analyse visuelle du portefeuille ===
st.markdown("<b><u>Analyse visuelle de la composition du portefeuille :</u></b>", unsafe_allow_html=True)
  ...
  if not secteurs_selectionnes:
      ...
      if df_personnalise.empty:
          ...
          if df_esg_personnalise.empty:
              ...
              st.markdown(f"""Dans cette dernière étape, vous avez choisi de composer votre portefeuille à partir des secteurs {', '.join(secteurs_selectionnes)}.
